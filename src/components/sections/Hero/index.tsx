    ...
    <section id="hero" className={styles.hero}>
      <div className={styles.content}>
        ...
        <p className={styles.description}>
          I build exceptional digital experiences for the web and mobile. Passionate about
          crafting clean, performant, and accessible applications that delight users and
        ...
        <div className={styles.socials}>
          ...
          <a href="mailto:aaron@example.com" aria-label="Email">
            <svg viewBox="0 0 24 24" fill="currentColor" width="22" height="22">
