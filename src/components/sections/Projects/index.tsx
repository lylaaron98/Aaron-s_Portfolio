...
export default function Projects() {
  ...
  return (
    <SectionContainer id="projects" title="Projects">
      <h2 style={{ marginBottom: 24, marginTop: 0, color: '#bfc4cf', fontSize: '1.5rem' }}>Personal Projects</h2>
      <div ref={refPersonal} className={styles.grid} style={{ marginBottom: 48 }}>
      ...
      <h2 style={{ marginBottom: 24, marginTop: 0, color: '#bfc4cf', fontSize: '1.5rem' }}>Client Projects</h2>
      <div ref={refClient} className={styles.grid}>
        {clientProjects.length === 0 ? (
          <div style={{ color: '#888', fontStyle: 'italic', padding: 24 }}>No client projects to display yet.</div>
        ) : (
